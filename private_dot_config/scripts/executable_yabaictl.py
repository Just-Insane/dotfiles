...
## From https://github.com/aiguofer/dotfiles/blob/master/user/.local/bin/yabaictl
## REF: https://github.com/koekeishiya/yabai/issues/365
...
setups = {
    ...
    #     "6F294B5A-1170-5B2F-B888-BFF30F1F0614",
    # ],
}
